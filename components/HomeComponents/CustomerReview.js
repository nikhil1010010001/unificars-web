    ...
    return (
        <div className='bg-white p-8'>
            <div className='w-5/6 mx-auto'>
                <h3 className='text-4xl text-blue-900'>What Our Clients Are Saying</h3>
                <section className="text-gray-600 body-font my-8">
                    <div className="">
                        <div className="flex flex-wrap -m-4 ">
                            <div className="lg:w-1/3 lg:mb-0 mb-6 p-4  transform transition-transform duration-300 hover:scale-105 cursor-pointer">
                            ...
                            <div className="lg:w-1/3 lg:mb-0 p-4 transform transition-transform duration-300 hover:scale-105 cursor-pointer">
                                <div className="h-full text-center">
