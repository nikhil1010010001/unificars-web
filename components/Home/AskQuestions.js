            ...
            <div className='w-10/12 mx-auto'>
                <Accordion className=''>
                    <AccordionSummary
                        ...
                        id="panel1a-header"
                    >
                        <Typography className='text-orange-500' >Q. Does it offer Home inspection as well?</Typography>
                    </AccordionSummary>
                    <AccordionDetails>
                        <Typography >
                ...
                <Accordion className=''>
                    <AccordionSummary
                        ...
                        id="panel2a-header"
                    >
                        <Typography className='text-orange-500'>Q. Should I make an appointment in advance?</Typography>
                    </AccordionSummary>
                    <AccordionDetails>
                        <Typography>
                ...
                <Accordion className=''>
                    <AccordionSummary
                        ...
                        id="panel2a-header"
                    >
                        <Typography className='text-orange-500'>Q. What is car testing?</Typography>
                    </AccordionSummary>
                    <AccordionDetails>
                        <Typography >
                ...
                <Accordion className=''>
                    <AccordionSummary
                        ...
                        id="panel2a-header"
                    >
                        <Typography className='text-orange-500'>Q. What are the perks of selling your car to Unifi cars?</Typography>
                    </AccordionSummary>
                    <AccordionDetails className='text-sm font-normal'>
                        ...
                        <ol className='font-normal'>
                            <li className='font-normal' >• Visit us once, and we'll give you the best offer we could find by simultaneously auctioning off your car via several channels throughout India. No fuss of waiting around for many bidders to arrive or gathering estimates from various purchasers over the course of days</li>
                            <li className='font-normal' >• Alternatively, choose Home Inspection, and we will come to your door to inspect the vehicle without you having to visit us even once.</li>
                            <li className='font-normal' >• The best prices: We've been working hard in this business for years and have gathered information from all over the nation from different sources, including our network of channel </li>
                            <li className='font-normal' >• There is no waiting to receive your money. Without charging extra, we provide one of the industry's quickest money transfers. The majority of our clients get their money the same day! Selling a car requires extensive documentation, possibly involving many trips to the RTO, and is not like selling a typical transportable item. The most fundamental of these is RC transfer.
                            </li>
                        </ol>
                ...
                <Accordion className=''>
                    <AccordionSummary
                        ...
                        id="panel2a-header"
                    >
                        <Typography className='text-orange-500'>Q. What are the accurate timings?</Typography>
                    </AccordionSummary>
                    <AccordionDetails>
                        <Typography >
