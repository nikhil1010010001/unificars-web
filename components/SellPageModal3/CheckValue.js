...
const CheckValue = ({
  ...
  const HandleGetOtp = async () => {
    ...
    if (UserNumber != "") {
      const data = {
        ...
        brand: UserCar.brand.name,
        model: UserCar.model.name,
        varient: UserCar.varient.name,
      };
  ...
  const getCarValuation = async () => {
    ...
    try {
      ...
      if (value.code == 200) {
        ...
        let remainingyears =
          UserCar.year + calculatedyear - new Date().getFullYear();
  ...
  return (
    <div className="w-12/12 mx-auto my-4">
      <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 my-8">
        <div className="bg-white shadow-xl border rounded-xl px-4 py-2">
          <div className="flex flex-col mt-2">
            <p className="tracking-widest font-bold text-gray-600 text-lg">
              Your Car Detail
            </p>
          ...
          <div className="flex flex-col gap-2 my-2 mt-6">
            <h3 className="text-lg">
              {UserCar.year} {UserCar.brand.name} {UserCar.model.name}{" "}
              {UserCar.varient.name}
            </h3>
            <p>
              <span className="w-full text-gray-800 inline-block mr-2 text-lg">
            ...
            <p>
              <span className="w-full text-gray-800 inline-block mr-2 text-lg">
                Fuel Type - {UserCar.fuelType}
              </span>
              
            </p>
            <p>
              <span className="w-full text-gray-800 inline-block mr-2 text-lg">
                KM DRIVEN - {UserCar.kmDriven} 
              </span>
        ...
        <div className="bg-white shadow-xl border rounded-xl px-4 py-2">
          {!OTPVerify && (
            <div className="flex flex-col">
              <p className="tracking-widest font-bold text-gray-600 text-lg">
                Enter your Mobile Number to know your car's valuation
              </p>
              <img src="/home/title_line.png" alt="line" className="w-24" />
            </div>
          )}
            ...
            {OTPVerify ? (
              <>
                {ExpectedPrice[0] !== 0 ? (
                  <div className="flex tracking-widest flex-col text-blue-900 justify-center items-center">
                    ...
                    <div className="bg-blue-500/20 p-2 rounded text-green-700 my-2">
                      <p>Price May Vary On Inspection</p>
                    </div>
                  </div>
                ) : (
                  <></>
                ...
                <button
                  ...
                  className="w-full p-2 text-center bg-[#f38102] text-white rounded shadow hover:bg-black hover:text-white transition-all duration-200 ease-in-out "
                >
                  Book Slot
                </button>
              </>
              ...
              <div>
                <div className="w-full my-2">
                  <input
                    ...
                    value={UserNumber}
                    className="w-full p-2 border outline-gray-200 rounded border-gray-200 text-xl"
                  />
                </div>
                {OtpSend ? (
                  <div>
                  ...
                  <div className="w-full">
                    <button
                      ...
                      className="w-full p-2 text-center bg-[#f38102] text-white rounded shadow hover:bg-black hover:text-white transition-all duration-200 ease-in-out text-lg"
                    >
                      GET OTP
                    </button>
                  </div>
