      ...
      { finalsubmission ==false ? (
        <>
          <div className="w-11/12 mx-auto">
            <div className="gap-2 flex text-base text-[#002441] flex items-center justify-center">
            ...
            {BookingDetails.timeslot != "" ? (
              <div className="flex flex-col justify-center items-center my-5">
                ...
                >
                  ...
                  <div className="mb-6">
                    <select className="form-select bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"  name="state"
