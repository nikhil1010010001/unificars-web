          ...
          {screen === 1 && (
            <div className={`p-4 flex flex-col justify-center items-start gap-4`} >
              ...
              <div className="inline-flex items-center space-x-2 w-full max-w-full overflow-hidden">
                <span className="text-xl font-semibold">Enter your car registration number</span>
                <Image
                  src="/4xfaster.png"
                  alt="4x Faster"
                  width={50} 
              ...
              {loading ? (
                ...
                <button className="bg-blue-500 text-white px-7 py-1 rounded-lg hover:bg-blue-600 text-base font-inter" onClick={submitCarNumber}>
                    Get Price
                </button>
               )}
