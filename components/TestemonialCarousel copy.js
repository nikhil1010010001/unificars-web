...
function TestemonialCarousel() {
  ...
  return (
    <Carousel responsive={responsive} arrows={false}>
      <div className="flex flex-col items-center bg-white shadow rounded md:p-6 p-2 mx-2 md:min-h-[342px] w-full">
        <div>
          <img
      ...
      <div className="flex flex-col items-center bg-white shadow rounded md:p-6 px-2 mx-2 md:min-h-[342px] w-full">
        <div>
          <img
