            ...
            <div>
                ...
                <div className="bg-gray-100 p-8 rounded">
                    ...
                    <form onSubmit={HandleFormSubmit} className="my-8 text-lg font-bold flex flex-col gap-4 text-gray-500" id="enquiry">
                        ...
                        <button type='submit' className="bg-orange-400 rounded-xl shadow p-2 text-gray-800 border disabled:border-0 border-orange-500 disabled:bg-orange-300" disabled={!(UserDetails.check)}>Submit</button>
                    </form>
                </div >
            </div >
