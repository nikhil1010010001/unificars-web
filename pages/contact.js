    ...
    return (
        <div className=''>
            <div className='relative' style={{paddingTop:'85px'}}>
                <div><img src='/contactus.png' className='w-[100%]'/></div>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-4 p-4' >
                ...
                <div className="p-8 md:pl-16 justify-self-center">
                    ...
                    <nav className="text-black text-sm">
                        <a href="#" className="hover:underline text-black">Home</a> / <span>Contact</span>
                    </nav>
                    </div>
                </div>
                ...
                <div className='p-8 rounded'>
                    <div className="space-y-4">
                        ...
                        <p className="text-gray-600">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour</p>
                        <form className="space-y-4" onSubmit={HandleFormSubmit} id="enquiry">
                            <div className="flex space-x-4">
                                <div className="w-1/2">
                                    <label htmlFor="name" className="block text-sm font-medium text-gray-700">
                                        Name
                                    </label>
                                    <input type="text" id="name" name="name" onChange={(e)=>UserInputChange(e)} value={UserDetails.name} className="mt-1 p-2 block w-full border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" />
                                ...
                                <div className="w-1/2">
                                    ...
                                    <input type="text" id="email" name="email" onChange={(e)=>UserInputChange(e)} value={UserDetails.email} className="mt-1 p-2 block w-full border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" />
                            ...
                            <div className="flex space-x-4">
                                <div className="w-1/2">
                                    ...
                                    <input type="number" id="mobile" name="mobile" onChange={(e)=>UserInputChange(e)} value={UserDetails.phone} className="mt-1 p-2 block w-full border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" />
                                ...
                                <div className="w-1/2">
                                    ...
                                    <input type="text" id="subject" name="subject" onChange={(e)=>UserInputChange(e)} value={UserDetails.subject} className="mt-1 p-2 block w-full border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" />
                            ...
                            <div>
                                ...
                                <textarea id="message" name="message" onChange={(e)=>UserInputChange(e)} value={UserDetails.message}  rows="4" className="mt-1 p-2 block w-full border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"></textarea>
                            ...
                            <button type='submit' className="bg-blue-500 rounded-md shadow p-2 px-4 border disabled:border-0 bg-blue-500 text-white disabled:bg-blue-300" disabled={!(UserDetails.check)}>Submit</button>
                        </form>
                    </div>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-4 p-4' >
                ...
                <div className="p-8 md:pl-16 justify-self-center" style={{width:'60%'}}>
                    {/* <Head>
                        <title>{title}</title>
                        <meta name="description" content={description} />
                        <link rel="canonical" href={canonicalUrl} />
                ...
                <div className='p-8 rounded'>
                    <div className="max-w-4xl mx-auto bg-white shadow-lg rounded-lg">
                        <div className="flex bg-blue-100 p-8 rounded justify-between">
                            ...
                            <p><a href="mailto:info@unificars.com" className="text-blue-600">info@unificars.com</a></p>
                        </div>
                        ...
                        <div className="flex bg-blue-100 p-8 rounded justify-between">
                            ...
                            <p><a href="tel:+919911771977" className="text-blue-600">+91 9911771977</a></p>
                        </div>
                        <div className="flex bg-white p-8 rounded justify-between">
