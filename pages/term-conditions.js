...
const terms = () => {
  return (
    <div className='bg-[url("/background/abtbg.jpg")]'>
      <div className="md:py-10 p-8">
        <h1 className="text-4xl text-blue-950">
          Terms & Condition<span className="text-[#f38102]">.</span>
        </h1>
        <p className="my-6 font-normal text-gray-600 tracking-wider">
        ...
        <p className="my-6 font-normal text-gray-600 tracking-wider">
          ...
          UNIFI WHEELS PRIVATE LIMITED''s relationship with you in relation to
          this website.
        </p>

        <p className="my-6 font-normal text-gray-600 tracking-wider">
          The term 'UNIFI WHEELS PRIVATE LIMITED' or 'us' or 'we' refers to the
          owner of the website whose registered/operational office is Building
          No. 1A, Top Floor, DLF, Moti Nagar, New West Delhi DELHI 110015. The
        ...
        <div>
          <h3 className="text-2xl my-8 text-blue-950">
            ...
            <span className="text-[#f38102]">:</span>
          </h3>

          <ul className="my-6 font-normal text-gray-600 tracking-widest flex flex-col gap-6 list-disc list-inside text-sm">
            <li>
              ...
              to the fullest extent permitted by law. • The content of the pages
              of this website is for your general information and use only. It
            ...
            <li>
              ...
              document without UNIFI WHEELS PRIVATE LIMITED’s prior written
              consent.
            </li>
        ...
        <div>
          <h3 className="text-2xl my-8 text-blue-950">
            Cancellation and Refund<span className="text-[#f38102]">:</span>
          </h3>
        ...
        <div>
          <h3 className="text-2xl my-8 text-blue-950">
            Shipping and Delivery<span className="text-[#f38102]">:</span>
          </h3>
