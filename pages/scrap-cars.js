...
const VehicleInfo = dynamic(() => import("@/components/NewComponents/VehicleInfo3"),{ssr: false});
...
const about = () => {
    ...
    return (
        <div className=''>
            ...
            <div className="relative bg-cover bg-center h-full" style={{ backgroundImage: 'url(/scrap-car.png)',paddingTop:'80px' }}>
                <div className="absolute inset-0 bg-black bg-opacity-50"></div>
                <div className="relative container mx-auto flex items-center justify-between h-96 px-6">
                    <div className="text-white">
                    <h1 className="text-4xl font-bold">Get the Best Price for your Scrap Car</h1>
                    <p className="mt-2">Scrapping of your car with Hassle-Free process & legal documentation.</p>
                    </div>
                    {/* <div className="bg-white p-6 rounded-lg shadow-lg"> */}
                        <div className="sticky-element bottom-28 bg-orange-500 p-4 self-baseline challan-headbg" style={{marginBottom:"120px"}}>
                          <VehicleInfo />
            ...
            <div className="relative max-w-5xl mx-auto px-4 pt-16">
                ...
                <h1 className='py-2 font-bold text-center text-3xl font-bold text-black'>Why Scrap Car With Unifi Cars</h1>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mt-6">
                    <div className="hover:bg-blue-500 hover:text-white bg-white text-black p-6 rounded-lg shadow-md h-56 place-content-center">
                        <h4 className="text-base font-semibold mb-2 buyh4 text-center">Get Best Price</h4>
                        <p className="mb-4">Get an accurate and fair quote for scrapping your car and helping the environment.</p>
                    </div>
                    <div className="hover:bg-blue-500 hover:text-white bg-white text-black p-6 rounded-lg shadow-md h-56 place-content-center">
                        <h4 className="text-base font-semibold mb-2 buyh4 text-center">Instant Disposal Certificate</h4>
                        <p className="mb-4">Get benefits on buying a new car with a Certificate of deposit.</p>
                    </div>
                    <div className="hover:bg-blue-500 hover:text-white bg-white text-black p-6 rounded-lg shadow-md h-56 place-content-center">
                        <h4 className="text-base font-semibold mb-2 buyh4 text-center">Transparency</h4>
            ...
            <h1 className='py-2 font-bold text-center text-3xl font-bold text-black'>Steps to scrap your car with Unifi cars</h1>

              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
                <div className="flex items-start space-x-3">
                  <div className="flex-shrink-0">
                    <div className="bg-orange-500 text-white rounded-full h-8 w-8 flex items-center justify-center">1</div>
                  </div>
                  <div className="flex-grow">
                    <p>Enter your vehicle registration number so we can verify your car details.</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="flex-shrink-0">
                    <div className="bg-orange-500 text-white rounded-full h-8 w-8 flex items-center justify-center">2</div>
                  </div>
                  <div className="flex-grow">
                    <p>Help us understand the condition of your car better for a better estimate.</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="flex-shrink-0">
                    <div className="bg-orange-500 text-white rounded-full h-8 w-8 flex items-center justify-center">3</div>
                  </div>
                  <div className="flex-grow">
                    <p>A registered scrap vendor will pick up your car at a time slot you choose.</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="flex-shrink-0">
                    <div className="bg-orange-500 text-white rounded-full h-8 w-8 flex items-center justify-center">4</div>
                  </div>
                  <div className="flex-grow">
                    <p>Get a secure, instant deposit into your bank account after pick up.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="max-w-6xl mx-auto p-6 mt-16 rounded-md">
              <h1 className='py-2 font-bold text-center text-3xl font-bold text-black'>Scrap Car Policy</h1>
              <p>
                The process of scrapping a car is guided by the Vehicle Scrappage Policy 2021 from the Government of India. According to this policy, when a car is too old or doesn't meet emission and fitness standards, it can be scrapped. Car owners can choose to scrap their vehicles voluntarily and get benefits like financial incentives, tax rebates, or discounts on buying a new vehicle. The scrapped cars are sent to authorized scrap yards, where they are taken apart, and the materials are recycled or disposed of responsibly. This policy helps reduce pollution, encourages recycling, and boosts the automotive industry, while also providing benefits to those who scrap their old cars.
              </p>
            ...
            <div className="max-w-6xl mx-auto p-6 rounded-md">
              <h1 className='py-2 font-bold text-center text-3xl font-bold text-black'>When Is It Time to Scrap Your Car?</h1>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 justify-items-center">
                {[
                  { type: 'Private Vehicle', petrol: '15 Days', diesel: '15 Days' },
                  { type: 'Commercial Vehicle', petrol: '15 Days', diesel: '15 Days' },
                ].map((vehicle, index) => (
                  <div key={index} className="bg-gray-100 p-6 rounded-md shadow-md flex flex-col items-center w-[60%] mt-6">
                    <div className="flex items-center mb-4">
                      <svg className="h-8 w-8 text-blue-500 mr-3" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
