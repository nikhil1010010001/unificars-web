  ...
  return (
    <div className='font-normal'>
      ...
      <div className='md:w-11/12 mx-auto '>
        <div>
          <div className="container mx-auto p-6">
            ...
            <div className=" text-lg ">
              <h5 className='text-justify'>Welcome to our platform for buying and selling used cars! We strive to provide a seamless and convenient experience for individuals looking to purchase or sell pre-owned cars.</h5>
            </div>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 container  gap-4 mt-16 lg:mt-24 '>

          <div className="text-4xl mx-4 font-bold text-orange-500">
            <h2 className='border-b-2 py-2' >Our <span className='text-blue-900' >Mission </span></h2>
            <p className='text-lg italic text-gray-600 my-2 text-justify'>At Unificars we are trying to rectify the pain points, still holding a pre owned car seller or buyer from selling or buying it online. There are already multiple platforms to buy or sell a car but what they lack in service, is our USP.
            </p><h6 className='text-lg text-black my-2 text-justify'>We think it's time to revolutionize the process of selling and buying pre owned cars in India.</h6>
          </div>
        ...
        <div className="container border-blue-200 border-2 shadow bg-gray-100 rounded-xl  mx-4 p-4 ">
          <h2 className='text-4xl font-bold text-orange-500 text-justify'> Community <span className='text-blue-900'>&amp; Support </span></h2>
          <h6 className='text-lg my-2 font-semibold text-gray-600 text-justify'>We are committed to creating a thriving online community for auto enthusiasts where members may share expertise, stories, and advice. To promote this sense of community, our platform may provide elements like forums, discussion boards, and user reviews. Additionally, we offer customer assistance channels to address any queries or worries you might have while purchasing or selling.</h6>
        </div>
        ...
        <div className='mb-8'>
          ...
          <div className="container  mx-auto p-2 my-4 shadow bg-gray-100 rounded-xl">
