...
const dealership = () => {
        ...
        const [UserDetails, setUserDetails] = useState({fname:"", email:"", mobile:"", state: "", check:false});
        const [msg, setMsg] = useState("");
        const [isFormSubmitted, setIsFormSubmitted] = useState(false);
    
        const UserInputChange = (e) => {
            const {name, value} = e.target;
            setUserDetails(prevDetails => name === "check" ? {...prevDetails, check: !prevDetails.check} : {...prevDetails, [name]: value});
        };
        ...
        const HandleFormSubmit = async (e) => {
            ...
            } else if (fname && state && mobile.match(/^(?:(?:\+|0{0,2})91(\s*[\-]\s*)?|[0]?)?[6789]\d{9}$/) && email.match(/^[A-Z0-9._%+-]+@[A-Z0-9.-]+\.[A-Z]{2,4}$/i)) {
    ...
    return (
        <div className=''>
            ...
            <div className='relative' style={{ paddingTop: '85px' }}>
                <div>
                    <img src='Banner-Image.png' className="hidden md:block  h-[40rem] w-[100rem] bannerimage" />
                ...
                <div className="setmaindiv3 absolute top-5 right-[5%] bg-white p-7 rounded mt-[120px] md:mt-[90px]" style={{ boxShadow: '0px 0px 16px 0px rgba(0, 0, 0, 0.25)',justifySelf: 'center!important', marginLeft: 'auto' }}>
                    {/* <div className="ribbon-pop font-bold text-2xl my-2 capitalize">Dealer Onboarding</div> */}
                    <h3 className="font-bold text-2xl my-2 capitalize text-center">BECOME OUR CHANNEL PARTNER</h3>
                    ...
                    <form onSubmit={HandleFormSubmit} id="enquiry">
                        ...
                        <div className="box form-grp w-full mt-5">
                            <input type="text" placeholder="Full Name" name="fname" id="fname" onChange={(e) => UserInputChange(e)} value={UserDetails.fname} required />
                        ...
                        <div className="box form-grp w-full mt-5">
                            <input type="email" placeholder="Your Email" name="email" id="email" onChange={(e)=>UserInputChange(e)} value={UserDetails.email} required/>
                        ...
                        <select className="form-select"  name="state" onChange={(e)=> UserInputChange(e)}  id="state" style={{ padding: '14px 10px', border: '1px solid black', borderRadius: '15px', color: 'rgb(34 34 34/79%)',fontWeight:'200',background: 'white' }} required>
                            <option selected>Select Your State</option>
                        ...
                        <div className="box form-grp w-full mt-5">
                            <input type="number" placeholder="Your Mobile" name="mobile" id="mobile" onChange={(e) => UserInputChange(e)} value={UserDetails.mobile} required />
                            {/* <label for="mobile">Your Mobile</label> */}
                        </div>

                        <div className="box w-full form-grp mt-5" style={{ display: isFormSubmitted ? 'flex' : 'none' }}>
                            <input type="number" placeholder="OTP" name="otp" id="otp" onChange={(e) => UserInputChange(e)} value={UserDetails.otp} requiredb={isFormSubmitted} />
                        ...
                        <div className="form-grp">
                            {!isFormSubmitted && ( // Show the 'Send OTP' button if form is not submitted
                                <button type='submit' className="bg-sky-700 rounded-xl shadow2 p-2 border disabled:border-0 border-orange-500 text-white disabled:bg-sky-700 mt-4">Register Now</button>
                            )}
                            {isFormSubmitted && ( // Show the 'Verify OTP' button if form is submitted
                                <button type='submit' className="bg-sky-700 rounded-xl shadow2 p-2 border disabled:border-0 border-orange-500 text-white disabled:bg-sky-700 mt-4" style={{ width: '100%' }}>Verify OTP</button>
                            )}
                        </div>
                        ...
                        <div className="p-4">
                            <div className="">
                                ...
                                <div className='text-center items-center flex flex-col mb-6'>
                                    ...
                                    <p className=' customgryfnt text-lg'>Unifi Cars ensures every deal is built on clarity, trust, and experience, so you can make smart and secure purchases.</p>
                ...
                <div className="py-10 text-center bg-gradient-radial from-white text-gray-600" >
                    <div className='w-11/12 mx-auto'>
                        ...
                        <div className='text-center items-center flex flex-col mb-6'>
                            ...
                            <p className=' customgryfnt text-lg'>Make your car buying journey easy and convenient with us.</p>
                        </div>
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
                            <div className="text-center flex flex-wrap justify-center cardhow">
                                ...
                                <div className="px-4 pb-3">
                                    <h4 className="text-xl text-orange-500 font-bold  uppercase mt-4 flex-none">Join our family</h4>
                                    <p className="mx-5 hiwpara font-normal">You can easily become the part of our family by downloading our auction app to take part in the auctions.</p>
                                </div>
                            </div>
                            <div className="text-center flex flex-wrap justify-center cardhow">
                                ...
                                <div className="px-4 pb-3">
                                    <h4 className="text-xl text-orange-500 font-bold  uppercase flex-none">On boarding form</h4>
                                    <p className="mx-5 hiwpara font-normal">Our advance methods quickly analyse your car price and get the estimate value of your car. </p>
                                </div>
                            </div>
                            <div className="text-center flex flex-wrap justify-center cardhow">
                                ...
                                <div className="px-4 pb-3">
                                    <h4 className="text-xl text-orange-500 font-bold  uppercase flex-none">Bid placing time</h4>
                                    <p className="mx-5 hiwpara font-normal">You can easily start the bidding from our wide range of cars. </p>
                                </div>
                            </div>
                            <div className="text-center flex flex-wrap justify-center cardhow">
                                ...
                                <div className="px-4 pb-3">
                                    <h4 className="text-xl text-orange-500 font-bold  uppercase flex-none">Deal closing time</h4>
                                    <p className="mx-5 hiwpara font-normal">Close the deal after winning the bid.</p>
                                </div>
                            </div>
                            <div className="text-center flex flex-wrap justify-center cardhow">
                                ...
                                <div className="px-4 pb-3">
                                    <h4 className="text-xl text-orange-500 font-bold  uppercase flex-none">Payment time</h4>
                                    <p className="mx-5 hiwpara font-normal">After winning the bidding we will offers the various payment methods just like online and offline methods.</p>
                                </div>
                            </div>
                            <div className="text-center flex flex-wrap justify-center cardhow">
                                ...
                                <div className="px-4 pb-3">
                                    <h4 className="text-xl text-orange-500 font-bold  uppercase flex-none">Delivery time</h4>
                                    <p className="mx-5 hiwpara font-normal">After completion of payment, we will provide you the doorstep delivery with all completed documents.</p>
                                </div>
                            </div>
                        </div>
